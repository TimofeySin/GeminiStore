package ru.timofeysin.geministore.services.urovo
...
import ru.timofeysin.geministore.SharedPref
...
class UrovoConnectionService : Service() {
    ...
    private fun createNotification() {
        ...
        val notificationIntent = Intent(this, ru.timofeysin.geministore.MainActivity::class.java)
